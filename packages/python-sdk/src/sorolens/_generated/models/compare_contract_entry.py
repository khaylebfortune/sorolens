...
if TYPE_CHECKING:
  from ..models.compare_contract_entry_event_volume_item import CompareContractEntryEventVolumeItem
...
class CompareContractEntry:
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.compare_contract_entry_event_volume_item import CompareContractEntryEventVolumeItem # noqa: PLC0415
        id = self.id
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for event_volume_item_data in (_event_volume):
            event_volume_item = CompareContractEntryEventVolumeItem.from_dict(event_volume_item_data)
