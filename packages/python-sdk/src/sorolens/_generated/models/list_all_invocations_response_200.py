...
T = TypeVar("T", bound="ListAllInvocationsResponse200")



@_attrs_define
class ListAllInvocationsResponse200:
    """ 
        Attributes:
            invocations (list[Invocation]):
            next_cursor (str): Opaque cursor for the next (older) page; empty when no more pages.
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_all_invocations_response_200 = cls(
            invocations=invocations,
            next_cursor=next_cursor,
        )


        list_all_invocations_response_200.additional_properties = d
        return list_all_invocations_response_200
