...
T = TypeVar("T", bound="V2MonitoredContract")



@_attrs_define
class V2MonitoredContract:
    """ 
        Attributes:
            contract_id (str):
            network (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v2_monitored_contract.additional_properties = d
        return v2_monitored_contract
