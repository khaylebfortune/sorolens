...
if TYPE_CHECKING:
  ...
  from ..models.v2_upgrade import V2Upgrade





T = TypeVar("T", bound="V2UpgradeList")
...
class V2UpgradeList:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for data_item_data in (_data):
            data_item = V2Upgrade.from_dict(data_item_data)
        ...
        v2_upgrade_list.additional_properties = d
        return v2_upgrade_list
